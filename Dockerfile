...
RUN wget https://github.com/taniman/profit-trailer/releases/download/2.1.5/ProfitTrailer-2.1.5.zip && \
  unzip -d ProfitTrailer ProfitTrailer-2.1.5.zip && \
  mv ProfitTrailer/ProfitTrailer-2.1.5/* ProfitTrailer && \
  rm -rf ProfitTrailer/ProfitTrailer-2.1.5
